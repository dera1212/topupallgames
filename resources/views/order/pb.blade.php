...
<html lang="en">
  <head>
    ...
    <title>Point Blank Zepetto Cash</title>
  ...
  <body>
    ...
    <div class="container-order">
        <div class="order-col1">
            <img src="{{ asset('img/pointblank.jpg') }}" alt="point blank zepetto cash">
            <h1>Top Up Point Blank Zepetto Cash</h1>
            <h3>Proses Top Up Instan</h3>
            <p>Informasi top up Point Blank Zepetto Cash termurah hanya di sini! Proses instan, cepat dan tidak ribet! Pembayaran mudah dan paling murah di antara lainnya!</p>
            <ol>
                <li>Masukan User ID</li>
                <li>Pilih Paket Cash</li>
                <li>Pilih Metode Pembayaran</li>
                <li>Tulis Nomor Whatsapp Aktiv</li>
                <li>Klik Pesan Sekarang</li>
                <li>Cash Akan Masuk Otomatis</li>
            </ol>
        </div>
          ...
          <div class="pilih-diamond">
            ...
            <div class="row-diamond" id="pilih">
              ...
              <div class="pilih-jumlah-diamond" >
                <input type="radio" class="btn-check" name="options1" value="1.200 Cash = Rp.12.912" id="pb1" autocomplete="off" checked>
                <label class="btn btn-primary" for="pb1">1.200 Cash <br>Rp.12.912</label>
                </div>
    
                <div class="pilih-jumlah-diamond">
                <input type="radio" class="btn-check" name="options1" value="2.400 Cash = Rp.22.362" id="pb2" autocomplete="off">
                <label class="btn btn-primary" for="pb2">2.400 Cash <br>Rp.22.362</label>
                </div>
    
                <div class="pilih-jumlah-diamond">
                <input type="radio" class="btn-check" name="options1" value="6.000 Cash = Rp.55.812" id="pb3" autocomplete="off">
                <label class="btn btn-primary" for="pb3">6.000 Cash <br>Rp.55.812</label>
                </div>
    
                <div class="pilih-jumlah-diamond">
                <input type="radio" class="btn-check" name="options1" value="12.000 Cash = Rp.110.462" id="pb4" autocomplete="off">
                <label class="btn btn-primary" for="pb4">12.000 Cash <br>Rp.110.462</label>
                </div>
    ...
    <script src="{{ asset('js/orderpb.js?v=1.0') }}"></script>
