  ...
  <body>
    ...
    <div class="container-order">
        <div class="order-col1">
            <img src="{{ asset('img/hago.jpg') }}" alt="Hago Diamond">
            <h1>Top Up Hago Diamond</h1>
            <h3>Proses Top Up Instan</h3>
            <p>Informasi top up Hago Diamond termurah hanya di sini! Proses instan, cepat dan tidak ribet! Pembayaran mudah dan paling murah di antara lainnya!</p>
            <ol>
          ...
          <div class="pilih-diamond">
            ...
            <div class="row-diamond" id="pilih">
              ...
              <div class="pilih-jumlah-diamond" >
                <input type="radio" class="btn-check" name="options1" value="45 Diamond = Rp.17.787" id="hg1" autocomplete="off" checked>
                <label class="btn btn-primary" for="hg1">45 Diamond <br>Rp.17.787</label>
                </div>
    
                <div class="pilih-jumlah-diamond">
                <input type="radio" class="btn-check" name="options1" value="90 Diamond = Rp.33.337" id="hg2" autocomplete="off">
                <label class="btn btn-primary" for="hg2">90 Diamond <br>Rp.33.337</label>
                </div>
    
                <div class="pilih-jumlah-diamond">
                <input type="radio" class="btn-check" name="options1" value="225 Diamond = Rp.75.362" id="hg3" autocomplete="off">
                <label class="btn btn-primary" for="hg3">225 Diamond <br>Rp.75.362</label>
                </div>
    
                <div class="pilih-jumlah-diamond">
                <input type="radio" class="btn-check" name="options1" value="375 Diamond = Rp.136.162" id="hg4" autocomplete="off">
                <label class="btn btn-primary" for="hg4">375 Diamond <br>Rp.136.162</label>
                </div>
    ...
    <script src="{{ asset('js/orderhago.js?v=1.0') }}"></script>
